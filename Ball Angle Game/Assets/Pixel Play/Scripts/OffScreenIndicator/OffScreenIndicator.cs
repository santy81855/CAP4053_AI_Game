...
public class OffScreenIndicator : MonoBehaviour
{
    ...
    private List<Targeting> targets = new List<Targeting>();

    public static Action<Targeting, bool> TargetStateChanged;
    ...
    void DrawIndicators()
    {
        foreach(Targeting target in targets)
        {
    ...
    private void HandleTargetStateChanged(Targeting target, bool active)
    {
        if(active)
        {
            targets.Add(target);
